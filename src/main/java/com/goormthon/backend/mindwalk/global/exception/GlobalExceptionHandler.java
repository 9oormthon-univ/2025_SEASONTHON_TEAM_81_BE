...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<BaseResponse<Void>> handleGeneralException(BaseException ex) {
		log.error(ex.getStatus().toString());
		return ResponseEntity.status(ex.getStatus().getHttpStatus())
			.body(BaseResponse.fail(ex.getStatus()));
	}
	...
	protected ResponseEntity<Object> handleExceptionInternal(
		...
		return ResponseEntity.status(status)
			.body(BaseResponse.fail(responseStatus));
	}
}
